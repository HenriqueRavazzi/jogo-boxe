...
/** Barra superior flutuante: recursos e HP da partida. */
export function TopBar() {
  ...
  return (
    <header className="pointer-events-none absolute inset-x-0 top-0 z-10 flex items-start justify-between gap-4 p-4">
      ...
      <div className="pointer-events-auto min-w-[10rem] rounded-lg bg-black/55 px-3 py-2 shadow-lg backdrop-blur-sm">
